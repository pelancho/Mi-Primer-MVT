...
from Proyecto1.views import saludar, segunda_vista, diaDeHoy, saludo_con_nombre, calculaAñoNacimiento, probandoHtml
...
urlpatterns = [
    ...
    path('calculaanio/<edad>', calculaAñoNacimiento),
